...
This [Coronavirus dashboard: the case of Spain](https://rpubs.com/AdSan-R/COVID_dashboard_Spain) provides an overview of the 2020 Novel Coronavirus COVID-19 epidemic for Spain This dashboard is built with R using the R Makrdown framework and was adapted from these:
